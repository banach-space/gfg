...
class IndexFile():
    ...
    def __parse(self):
        ...
        Limitations:
            * The extensions are just stored as bytes rather than parsed like
              other fields
        """
    ...
    def print_to_bytes(self):
        ...
        # Extensions are stored as original bytes, so no need to re-pack them
        contents += self.extensions
